...
- Verified free import observations for nine support series now work offline on the reference basis; estimated or missing weights are excluded. A keyless snapshot collector records missing months and stops at provider limits; the paper can explicitly include this snapshot and select a shared publication month.
...
The [free-data update audit](audit/free-data-update-2026-09-06.md) and [September7 resumption](audit/free-data-resume-2026-09-07.md) record verification, numerical effects and remaining source gaps. Data acquisition remains free; no paid purchase, subscription or billable API was used.
